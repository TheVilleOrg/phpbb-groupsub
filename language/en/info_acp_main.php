...
$lang = array_merge($lang, array(
	...
	'ACP_GROUPSUB_PKG_GROUPS_PERM'				=> 'Package add permanent groups',
	'ACP_GROUPSUB_PKG_GROUPS_PERM_EXPLAIN'		=> 'Select one or more groups to which to grant permanent access to subscribers.<br>Once subscribers are added then will not be removed even after subscription ends.',
	'ACP_GROUPSUB_PKG_GROUPS'					=> 'Package groups',
	'ACP_GROUPSUB_PKG_GROUPS_EXPLAIN'			=> 'Select one or more groups to which to grant access to subscribers.<br>Subscribers are added till subscription ends.',
	'ACP_GROUPSUB_PKG_GROUPS_NEW'				=> 'Package remove permanently from “Newly Registered Users” group',
	'ACP_GROUPSUB_PKG_GROUPS_NEW_EXPLAIN'		=> 'Select to remove subscribers from “Newly Registered Users” group.<br>Once subscribers are removed then will not be added back even after subscription ends.',
